...
async function handleAgentConference(request) {
  try {
    ...
    // startConferenceOnEnter="true" means agent starts the conference when they join
    // Customer is already waiting in the conference, so agent starting it will connect both
