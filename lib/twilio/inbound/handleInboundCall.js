...
<Response>
  ...
  <Dial record="false" timeout="300" timeLimit="3600" answerOnMedia="false" hangupOnStar="false" statusCallback="${statusCallbackUrl.toString()}" statusCallbackEvent="initiated ringing answered completed">
    <Conference startConferenceOnEnter="false" endConferenceOnExit="false" beep="false" maxParticipants="5" muted="false" waitUrl="${conferenceHoldMusicUrl}" waitMethod="GET" statusCallback="${conferenceCallbackUrl}" statusCallbackMethod="POST" statusCallbackEvent="start end join leave mute hold speaker">${conferenceName}</Conference>
  </Dial>
</Response>`;
