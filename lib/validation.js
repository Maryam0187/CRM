...
export const isCardExpired = (expiryDate) => {
  ...
  try {
    ...
    // For credit card expiry dates, always assume 2000s (20xx)
    // Years 00-99 are interpreted as 2000-2099
    const fullCardYear = 2000 + cardYear;
...
export const isCardExpiringSoon = (expiryDate, monthsAhead = 3) => {
  ...
  try {
    ...
    // Convert 2-digit year to 4-digit (always assume 2000s for credit cards)
    const fullCardYear = 2000 + cardYear;
