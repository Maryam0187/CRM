...
const getStatusBadgeClasses = (status) => {
  const badgeClasses = {
    ...
    [SALES_STATUSES.PAYMENT_INFO]: 'bg-yellow-100 text-yellow-800',
    [SALES_STATUSES.CANCELLED]: 'bg-red-200 text-red-900',
    [SALES_STATUSES.SALE_DONE]: 'bg-green-200 text-green-900',
    [SALES_STATUSES.VERIFICATION]: 'bg-indigo-100 text-indigo-800',
    [SALES_STATUSES.PROCESS]: 'bg-yellow-100 text-yellow-800',
