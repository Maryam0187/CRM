...
export const SaleService = {
  ...
  async findByStatusPaginated(status, page = 1, limit = 10, numberSearch = null, searchLastFour = false) {
    return await this.findWithPagination({
      page,
      limit,
      where: { status },
  ...
  async findByStatusAndDatePaginated(status, dateFilter, page = 1, limit = 10, dateField = 'created_at', numberSearch = null, searchLastFour = false) {
    const { startDate, endDate } = this.parseDateFilter(dateFilter, dateField);
  ...
  async findByAgentStatusPaginated(agentId, status, page = 1, limit = 10, numberSearch = null, searchLastFour = false) {
    return await this.findWithPagination({
  ...
  async findByAgentStatusAndDatePaginated(agentId, status, dateFilter, page = 1, limit = 10, dateField = 'created_at', numberSearch = null, searchLastFour = false) {
    const { startDate, endDate } = this.parseDateFilter(dateFilter, dateField);
    return await this.findWithPagination({
      where: { 
        agentId,
