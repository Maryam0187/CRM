...
export const SaleService = {
  ...
  async findWithPagination(options = {}) {
    ...
    // Get the actual data with includes
    // Ensure we're using models from sequelize instance for associations
  ...
  async findByDatePaginated(dateFilter, page = 1, limit = 10, dateField = 'created_at') {
    const { startDate, endDate } = this.parseDateFilter(dateFilter, dateField);
  ...
  async findByStatusAndDatePaginated(status, dateFilter, page = 1, limit = 10, dateField = 'created_at') {
    const { startDate, endDate } = this.parseDateFilter(dateFilter, dateField);
  ...
  async findByAgentPaginated(agentId, page = 1, limit = 10) {
    return await this.findWithPagination({
      where: { agentId },
      page,
      limit,
  ...
  async findByAgentStatusPaginated(agentId, status, page = 1, limit = 10) {
    return await this.findWithPagination({
  ...
  async findByAgentDatePaginated(agentId, dateFilter, page = 1, limit = 10, dateField = 'created_at') {
    const { startDate, endDate } = this.parseDateFilter(dateFilter, dateField);
    return await this.findWithPagination({
      where: { 
        agentId,
  ...
  async findByAgentStatusAndDatePaginated(agentId, status, dateFilter, page = 1, limit = 10, dateField = 'created_at') {
    const { startDate, endDate } = this.parseDateFilter(dateFilter, dateField);
    return await this.findWithPagination({
      where: { 
        agentId,
