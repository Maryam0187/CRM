...
export default function IVRDialerModal({ 
  ...
  const [showSavedList, setShowSavedList] = useState(true); // Always show saved list
  ...
  return (
    <>
      ...
      <div 
        className="fixed bottom-4 bg-white rounded-lg shadow-2xl w-[800px] max-w-[calc(100vw-2rem)] z-[10001] overflow-hidden"
        style={{ 
          right: rightOffset,
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-blue-500 to-blue-600">
          <div className="flex-1 min-w-0">
            ...
            {callLabel && (
              <p className="text-xs text-blue-100 mt-1 truncate">{callLabel}</p>
            )}
          </div>
          ...
          <div className="flex-1 p-6 border-r border-gray-200 flex flex-col" style={{ minHeight: '500px', height: '500px' }}>
            ...
            {mode === 'dial' && (
              <>
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  <button onClick={() => handleDigitClick('1')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">1</button>
                  <button onClick={() => handleDigitClick('2')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">2</button>
                  <button onClick={() => handleDigitClick('3')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">3</button>
                  <button onClick={() => handleDigitClick('4')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">4</button>
                  <button onClick={() => handleDigitClick('5')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">5</button>
                  <button onClick={() => handleDigitClick('6')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">6</button>
                  <button onClick={() => handleDigitClick('7')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">7</button>
                  <button onClick={() => handleDigitClick('8')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">8</button>
                  <button onClick={() => handleDigitClick('9')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">9</button>
                  <button onClick={() => handleDigitClick('*')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">*</button>
                  <button onClick={() => handleDigitClick('0')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">0</button>
                  <button onClick={() => handleDigitClick('#')} className="bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-800 font-bold text-xl py-4 px-4 rounded-lg transition-all duration-150 shadow-sm">#</button>
                </div>
                ...
                <div className="flex gap-2 mb-3">
                  <button
                    ...
                    className="flex-1 bg-yellow-500 hover:bg-yellow-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  onClick={handleCall}
                  disabled={!canCall}
                  className="w-full bg-green-600 hover:bg-green-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 shadow-lg"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.517l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
            ...
            {mode === 'ivr' && (
              <>
                <div className="mb-6">
                  <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-4 text-center">
                    <div className="text-3xl font-mono font-bold text-gray-800 min-h-[48px] flex items-center justify-center">
                ...
                <button
                  ...
                  disabled={!canSend}
                  className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 shadow-lg"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {!showAddNewSection ? (
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="text-sm font-semibold text-gray-700">Add New Helpline</h4>
                    <button
                      onClick={() => {
                        setShowAddNewSection(false);
                        setNewHelplineNumber('');
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        // Allow paste and manual entry
                        setNewHelplineNumber(e.target.value);
                      }}
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              {savedHelplines.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-500">No saved helplines</p>
                  <p className="text-xs text-gray-400 mt-1">Add a new helpline above</p>
                </div>
              ) : (
                <div className="space-y-2">
                  {savedHelplines.map((helpline) => (
                    <div
                        ...
                        <>
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              className="flex-1 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium rounded transition-colors flex items-center justify-center gap-1"
                            >
                            ...
                            <button
                              ...
                              className="px-2 py-1.5 text-gray-600 hover:bg-gray-100 rounded text-xs"
                              title="Edit"
                            >
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
